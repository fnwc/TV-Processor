...
namespace Common
{
	public static class ShowAliases
	{
		public static string RenameByAlias(string name)
		{
			...
			{
				new KeyValuePair<string, string>("30 for 30","ESPN 30 for 30"),
